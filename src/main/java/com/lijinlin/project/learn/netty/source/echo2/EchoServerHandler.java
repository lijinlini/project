 ...
 * under the License.
 */
package com.lijinlin.project.learn.netty.source.echo2;
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws InterruptedException, UnsupportedEncodingException {
        ...
        /*ctx.channel().eventLoop().execute(new Runnable() {
            ...
            public void run() {
                try{
                    Thread.sleep(5 * 1000);
                    //输出线程名
                    System.out.println("EchoServerHandler execute的线程1是=" + Thread.currentThread().getName());
        ...
        /*group.submit(new Callable<Object>() {
            ...
            public Object call() throws Exception {
                ...
                System.out.println("group.submit 的  call线程是=" + Thread.currentThread().getName());
