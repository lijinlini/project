...
public final class MyDataInfo {
  ...
  public interface MyMessageOrBuilder extends
     ...
     * <code>.Worder worker = 3;</code>
     */
    WorderOrBuilder getWorkerOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              Worder.Builder subBuilder = null;
              if (dataBodyCase_ == 3) {
                subBuilder = ((Worder) dataBody_).toBuilder();
              }
              dataBody_ =
                  input.readMessage(Worder.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom((Worder) dataBody_);
                dataBody_ = subBuilder.buildPartial();
              }
              dataBodyCase_ = 3;
              break;
     ...
     */
    @Override
    public Worder getWorker() {
      if (dataBodyCase_ == 3) {
         return (Worder) dataBody_;
      }
      return Worder.getDefaultInstance();
    }
    /**
     * <code>.Worder worker = 3;</code>
     */
    @Override
    public WorderOrBuilder getWorkerOrBuilder() {
      if (dataBodyCase_ == 3) {
         return (Worder) dataBody_;
      }
      return Worder.getDefaultInstance();
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (dataBodyCase_ == 3) {
        output.writeMessage(3, (Worder) dataBody_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (dataBodyCase_ == 3) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, (Worder) dataBody_);
      }
    ...
    public static final class Builder extends
      ...
      // Construct using com.lijinlin.project.learn.netty.codec2.MyDataInfo.MyMessage.newBuilder()
      private Builder() {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          Worder, Worder.Builder, WorderOrBuilder> workerBuilder_;
      /**
       * <code>.Worder worker = 3;</code>
       * @return Whether the worker field is set.
       */
       ...
       * <code>.Worder worker = 3;</code>
       */
      public Builder setWorker(Worder value) {
        if (workerBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setWorker(
          Worder.Builder builderForValue) {
        if (workerBuilder_ == null) {
          dataBody_ = builderForValue.build();
          onChanged();
        } else {
       ...
       * <code>.Worder worker = 3;</code>
       */
      public Builder mergeWorker(Worder value) {
        if (workerBuilder_ == null) {
          if (dataBodyCase_ == 3 &&
              dataBody_ != Worder.getDefaultInstance()) {
            dataBody_ = Worder.newBuilder((Worder) dataBody_)
                .mergeFrom(value).buildPartial();
          } else {
            dataBody_ = value;
          }
       ...
       * <code>.Worder worker = 3;</code>
       */
      public Worder.Builder getWorkerBuilder() {
       ...
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          Worder, Worder.Builder, WorderOrBuilder>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      // Construct using com.lijinlin.project.learn.netty.codec2.MyDataInfo.Student.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
  ...
  public interface WorderOrBuilder extends
      // @@protoc_insertion_point(interface_extends:Worder)
      com.google.protobuf.MessageOrBuilder {
  ...
  /**
   * Protobuf type {@code Worder}
   */
  public static final class Worder extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:Worder)
      WorderOrBuilder {
  private static final long serialVersionUID = 0L;
    // Use Worder.newBuilder() to construct.
    private Worder(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
      super(builder);
    }
    private Worder() {
      name_ = "";
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return MyDataInfo.internal_static_Worder_descriptor;
    }

    @Override
    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return MyDataInfo.internal_static_Worder_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Worder.class, Builder.class);
    }
    ...
    public static Worder parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static Worder parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Worder parseFrom(
    ...
    public static Worder parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static Worder parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static Worder parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(Worder prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements
        // @@protoc_insertion_point(builder_implements:Worder)
        WorderOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return MyDataInfo.internal_static_Worder_descriptor;
      ...
      // Construct using com.lijinlin.project.learn.netty.codec2.MyDataInfo.Worder.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      @Override
      public Worder getDefaultInstanceForType() {
        return Worder.getDefaultInstance();
      }

      @Override
      public Worder build() {
        Worder result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @Override
      public Worder buildPartial() {
        Worder result = new Worder(this);
        result.name_ = name_;
        result.age_ = age_;
        onBuilt();
        return result;
      ...
      @Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Worder) {
          return mergeFrom((Worder)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(Worder other) {
        if (other == Worder.getDefaultInstance()) return this;
        if (!other.getName().isEmpty()) {
          name_ = other.name_;
          onChanged();
        }
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Worder parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Worder) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  checkByteStringIsUtf8(value);
      ...
      // @@protoc_insertion_point(builder_scope:Worder)
    }

    // @@protoc_insertion_point(class_scope:Worder)
    private static final Worder DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new Worder();
    }

    public static Worder getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }

    private static final com.google.protobuf.Parser<Worder>
        PARSER = new com.google.protobuf.AbstractParser<Worder>() {
      @Override
      public Worder parsePartialFrom(
          com.google.protobuf.CodedInputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return new Worder(input, extensionRegistry);
      }
    };

    public static com.google.protobuf.Parser<Worder> parser() {
      return PARSER;
    }

    @Override
    public com.google.protobuf.Parser<Worder> getParserForType() {
      return PARSER;
    }
  ...
  private static final com.google.protobuf.Descriptors.Descriptor
    internal_static_Worder_descriptor;
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_Worder_fieldAccessorTable;
  ...
  static {
    ...
    internal_static_Worder_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_Worder_descriptor,
        new String[] { "Name", "Age", });
  }
